			...
			if(Turn_Off(Voltage)==0&&robot_mode_check_flag==0)
			 { 	
				 ...
				 MOTOR_D.Motor_Pwm=Incremental_PI_D(MOTOR_D.Encoder, MOTOR_D.Target);
				  ...
				  //else if (Car_Mode==6)	 Set_Pwm( MOTOR_A.Motor_Pwm, MOTOR_B.Motor_Pwm, MOTOR_C.Motor_Pwm, MOTOR_D.Motor_Pwm);    //高配麦轮独立悬挂       SENIOR_MEC_DL MD36N_51 定制专用 Customized special
