...
void PS2_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2;	    //Port configuration //端口配置
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPD; //Drop input //下拉输入
  GPIO_Init(GPIOC, &GPIO_InitStructure);				//Initialize the gpioC according to the set parameter //根据设定参数初始化GPIOC
	
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1;	        //Port configuration //端口配置
  ...
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;  //Pull the output //推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz; //50M
  GPIO_Init(GPIOB, &GPIO_InitStructure);					  //Initialize the gpioB according to the set parameter //根据设定参数初始化GPIOB
	
	GPIO_InitStructure.GPIO_Pin =GPIO_Pin_4;	        //Port configuration //端口配置
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;  //Pull the output //推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz; //50M
  GPIO_Init(GPIOA, &GPIO_InitStructure);					  //Initialize the gpioA according to the set parameter //根据设定参数初始化GPIOA  	  	 											  
}
/**************************************************************************
