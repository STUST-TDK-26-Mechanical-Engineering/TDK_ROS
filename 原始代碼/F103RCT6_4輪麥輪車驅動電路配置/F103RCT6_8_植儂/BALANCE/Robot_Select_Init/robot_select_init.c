...
//		if (Car_Mode==5)  Robot_Init(TOP_MEC_DL_wheelspacing,    TOP_MEC_DL_axlespacing,    MD60N_18, Photoelectric_500, Mecanum_152); //TOP_MEC_DL_18 - 顶配麦轮独立悬挂常规型
		...
		//Eight_drive_SENIOR_MEC_DL - 8驱_高配麦轮独立悬挂常规型
		//Eight_drive_TOP_MEC_DL    - 8驱_顶配麦轮独立悬挂常规型
	...
	#elif Omni
	{
	  ...
	  if (Car_Mode==1)  Robot_Init(Omni_Turn_Radiaus_180, MD36N_27,   Photoelectric_500, FullDirecion_127);//SENIOR_OMNI_27   - 高配全向轮三角形常规     
		...
		if (Car_Mode==4)  Robot_Init(Omni_Turn_Radiaus_290, MD60N_18,   Photoelectric_500, FullDirecion_127);//TOP_OMNI_18      - 顶配全向轮重载直径127   
		if (Car_Mode==5)  Robot_Init(Omni_Turn_Radiaus_290, MD60N_18,   Photoelectric_500, FullDirecion_152);//TOP_OMNI_18      - 顶配全向轮重载直径152
		if (Car_Mode==6)  Robot_Init(Omni_Turn_Radiaus_290, MD60N_18,   Photoelectric_500, FullDirecion_203);//TOP_OMNI_18      - 顶配全向轮重载直径203
	}
	#endif
}
